...
export class OrganizationsStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: cdk.StackProps) {
    ...
    // ── OUs ──────────────────────────────────────────────────────────────
    const securityOu = new organizations.CfnOrganizationalUnit(
      this,
      "SecurityOU",
      {
        name: "Security",
        parentId:
          this.node.tryGetContext("lexAgents:rootOuId") ??
          "PLACEHOLDER_ROOT_OU_ID",
      },
    );

    const infraOu = new organizations.CfnOrganizationalUnit(
      this,
      "InfrastructureOU",
      {
        name: "Infrastructure",
    ...
    const denyNonEuRegions = new organizations.CfnPolicy(
      this,
      "DenyNonEuRegions",
      {
        ...
        description:
          "Allow only eu-central-1 and eu-west-1 (DORA data residency)",
        content: {
          Version: "2012-10-17",
          Statement: [
            {
    ...
    const denyUnencryptedStorage = new organizations.CfnPolicy(
      this,
      "DenyUnencryptedStorage",
      {
        ...
        type: "SERVICE_CONTROL_POLICY",
        description:
          "Deny S3 PutObject without SSE-KMS and EBS without encryption",
        content: {
          Version: "2012-10-17",
          Statement: [
            {
    ...
    const requireMfaSensitiveActions = new organizations.CfnPolicy(
      this,
      "RequireMFASensitiveActions",
      {
    ...
    new cdk.CfnOutput(this, "SecurityOuId", {
      ...
      exportName: "LexAgents-SecurityOuId",
    });
    new cdk.CfnOutput(this, "InfraOuId", {
      value: infraOu.ref,
      exportName: "LexAgents-InfraOuId",
    });
    new cdk.CfnOutput(this, "WorkloadsOuId", {
      value: workloadsOu.ref,
      exportName: "LexAgents-WorkloadsOuId",
    });
    ...
    NagSuppressions.addStackSuppressions(this, [
      {
        ...
        reason: "Organizations SCP policies are not IAM policies on resources",
      },
      {
        id: "AwsSolutions-IAM5",
        reason: "SCPs require Resource: * by design to apply org-wide",
      },
      {
        id: "HIPAA.Security-IAMNoInlinePolicy",
        reason: "SCPs are not IAM inline policies on identities",
      },
    ]);
  }
}
