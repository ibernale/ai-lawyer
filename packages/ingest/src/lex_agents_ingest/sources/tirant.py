"""Tirant lo Blanch source stub.

Status: ADR 0011 RED — blocked until a signed API contract with Tirant lo Blanch exists.
...
_RED_MSG = (
    "Tirant lo Blanch: ADR 0011 RED — requiere contrato API firmado "
    "por Santander Legal. Ver docs/legal/comerciales-status.md"
)


class TirantSource(Source):
    """Tirant lo Blanch source — RED stub.

    All methods raise NotImplementedError.  No connector is implemented until
    Santander Legal provides a signed API agreement with Tirant lo Blanch.
    See docs/legal/comerciales-status.md.
    """
