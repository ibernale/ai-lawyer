"""Aranzadi (Thomson Reuters) source — prepared but disabled. ADR 0029.
...
class AranzadiSource(Source):
    """Aranzadi (Thomson Reuters) source — disabled until license signed.
