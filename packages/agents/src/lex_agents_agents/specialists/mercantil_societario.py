"""Specialist: Spanish corporate / commercial law (Maker)."""
...
class MercantilSocietarioAgent(BaseSpecialist):
    branch_id = "mercantil_societario"
    prompt_name = "especialistas/mercantil_societario"
    prompt_version = 1
