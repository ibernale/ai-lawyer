"""Specialist: PSD2/PSD3 payment services (Maker)."""
...
class Psd2PaymentServicesAgent(BaseSpecialist):
    branch_id = "psd2_payment_services"
    prompt_name = "especialistas/psd2_payment_services"
    prompt_version = 1
