"""Specialist: AML/Sanciones — PBC, FT and financial sanctions (Maker)."""
...
class AmlComplianceAgent(BaseSpecialist):
    branch_id = "aml_compliance"
    prompt_name = "especialistas/aml_compliance"
    prompt_version = 1
