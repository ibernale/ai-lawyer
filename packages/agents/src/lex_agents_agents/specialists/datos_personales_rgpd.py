"""Specialist: RGPD / personal data protection (Maker)."""
...
class DatosPersonalesRgpdAgent(BaseSpecialist):
    branch_id = "datos_personales_rgpd"
    prompt_name = "especialistas/datos_personales_rgpd"
    prompt_version = 1
