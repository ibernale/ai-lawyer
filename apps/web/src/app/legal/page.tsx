    ...
    <div className="mx-auto max-w-2xl px-4 py-10 space-y-8">
      <header>
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          lex-agents es un sistema de apoyo interno en fase MVP. Todo el contenido generado es un
          borrador asistido por IA y requiere validación por un jurista cualificado antes de
          cualquier uso externo o toma de decisiones.
        </p>
      </header>

      <div className="rounded-md border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800">
        <strong>Sistema en fase MVP.</strong> El dataset y los prompts no han sido validados por un
        experto humano. <code>expert_reviewed: false</code> en todos los casos del dataset de
