  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-8 space-y-8">
      ...
      <section aria-labelledby="acciones-title">
        <h2 id="acciones-title" className="mb-3 text-sm font-semibold uppercase tracking-wider text-muted-foreground">
          Acceso rápido
        </h2>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        {/* System status */}
        <section aria-labelledby="estado-title" className="rounded-lg border border-border bg-card p-5 shadow-sm">
          <h2 id="estado-title" className="mb-4 text-sm font-semibold uppercase tracking-wider text-muted-foreground">
            Estado del sistema
          </h2>
          {health === null ? (
            <div className="flex items-center gap-3">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <StatusBadge
                  ...
                  label={health.deps_status.anthropic_api === "configured" ? "Configurada" : "No configurada"}
                />
              </div>
        ...
        <section aria-labelledby="recientes-title" className="rounded-lg border border-border bg-card p-5 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <h2 id="recientes-title" className="text-sm font-semibold uppercase tracking-wider text-muted-foreground">
              Últimas consultas
            </h2>
            <Link href="/historico" className="text-xs text-brand-600 hover:underline">
              Ver todo →
            </Link>
          </div>
          <Suspense fallback={
